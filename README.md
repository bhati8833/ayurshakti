...
| `docs/02-cloudflare.md` | **Cloudflare** — DNS, Workers, edge caching. |
| `docs/03-gcp-apis.md` | **GCP APIs** — Indexing, Analytics, Search Console, PageSpeed. |
| `docs/05-analytics-seo.md` | **Analytics & SEO** — GA4, GSC, Indexing API, Bing IndexNow. |
| `docs/06-credentials.md` | **Credentials reference** — secret locations and environment mapping. |
| `docs/07-ai-agent-guide.md` | **AI agent guide** — task routing, skills, Next.js build workflow. |
| `docs/08-topic-research-rule.md` | **Topic research** — keyword strategy and botanical profiles. |
| `docs/09-article-writing-rule.md` | **Article writing** — human-touch rules, SEO quality checklist. |
| `docs/11-article-approval-scheduler.md` | **Approval & scheduler** — static build & Indexing API pipeline. |
| `docs/12-backlink-strategy.md` | **Backlink strategy** — automation & outreach strategy. |
| `docs/14-content-tracking-system.md` | **Content tracking** — tracking static publication status. |
| `docs/15-email-marketing-system.md` | **Email marketing** — Next.js form embeds + Google Apps Script. |
| `docs/17-traffic-growth-strategy.md` | **Traffic growth** — indexing foundation and performance tuning. |
| `docs/ARCHITECTURE.md` | **Architecture** — detailed Next.js static build & deployment flow. |
| `docs/CONFIGURATION.md` | **Configuration** — complete infrastructure settings. |
